...
def main(args):
    ...
    if args.ckpt1 and os.path.isfile(args.ckpt1):
        ...
        ckpt_path1 = os.path.join(pretrained_file_name1, "last_epoch_ckpt.checkpoints.tar")
    ...
    if args.ckpt2 and os.path.isfile(args.ckpt2):
        ...
        ckpt_path2 = os.path.join(pretrained_file_name2, "last_epoch_ckpt.checkpoints.tar")
