...
class Two2(Distiller):
    def __init__(self, student, teacher1, teacher2,cfg):
        super(Two2, self).__init__(student, teacher1,teacher2)
        self.shapes1 = cfg.Two2.SHAPES1
        self.shapes2 = cfg.Two2.SHAPES2
        self.out_shapes1 = cfg.Two2.OUT_SHAPES1
        self.out_shapes2 = cfg.Two2.OUT_SHAPES2
        in_channels1 = cfg.Two2.IN_CHANNELS1
        in_channels2 = cfg.Two2.IN_CHANNELS2
        out_channels1 = cfg.Two2.OUT_CHANNELS1
        out_channels2 = cfg.Two2.OUT_CHANNELS2
        self.ce_loss_weight1 = cfg.Two2.CE_WEIGHT1
        self.reviewkd_loss_weight = cfg.Two2.REVIEWKD_WEIGHT
        self.warmup_epochs = cfg.Two2.WARMUP_EPOCHS
        self.stu_preact = cfg.Two2.STU_PREACT
        self.max_mid_channel = cfg.Two2.MAX_MID_CHANNEL

        self.ce_loss_weight2 = cfg.Two2.CE_WEIGHT2
        self.temperature = cfg.Two2.TEMPERATURE
        self.kd_loss_weight = cfg.Two2.LOSS.KD_WEIGHT
    ...
    def forward_train(self, image, target, **kwargs):
        ...
        loss_kd1 = self.kd_loss_weight * kd_loss(
            logits_student, logits_teacher1, self.temperature
        )
        loss_kd2 = self.kd_loss_weight * kd_loss(
            logits_student, logits_teacher2, self.temperature
        )

        loss_reviewkd = (1-CE2/CE)*loss_reviewkd2+(1-CE1/CE)*loss_reviewkd1
        loss_dkd = (1-CE2/CE)*loss_kd2+(1-CE1/CE)*loss_kd1
