...
class ReviewKD_AT(Distiller):
    def __init__(self, student, teacher, cfg):
        super(ReviewKD_AT, self).__init__(student, teacher)
        self.shapes = cfg.REVIEWKD_AT.SHAPES
        self.out_shapes = cfg.REVIEWKD_AT.OUT_SHAPES
        in_channels = cfg.REVIEWKD_AT.IN_CHANNELS
        out_channels = cfg.REVIEWKD_AT.OUT_CHANNELS
        self.ce_loss_weight = cfg.REVIEWKD_AT.CE_WEIGHT
        self.reviewkd_loss_weight = cfg.REVIEWKD_AT.REVIEWKD_WEIGHT
        self.warmup_epochs = cfg.REVIEWKD_AT.WARMUP_EPOCHS
        self.stu_preact = cfg.REVIEWKD_AT.STU_PREACT
        self.max_mid_channel = cfg.REVIEWKD_AT.MAX_MID_CHANNEL
        self.p = cfg.REVIEWKD_AT.P
    ...
    def forward_train(self, image, target, **kwargs):
        ...
        loss_reviewkd = (
            ...
            * at_loss(results, features_teacher,self.p)
        )
        losses_dict = {
            "loss_ce": loss_ce,
